%% coed to run simulations of the moment closed isham model with treatment
% switched on or off by a switch. The code then plots the results of the
% control and calculets cost.
clear all
close all
